...
std::string generateHeader(char const* rev_str, char const* date_str, char const* time_str, char const* hash_str)
{
    ...
    if (!strcmp(rev_str,"Archive") || !strcmp(rev_str,"*"))
    {
        ...
        newData << " #define VER_PRODUCTVERSION     0,0,0,0"<< std::endl;
    }
    else
    {
        newData << " #define VER_FILEVERSION        0,0," << rev_str << ",0"<< std::endl;
        newData << " #define VER_PRODUCTVERSION     0,0," << rev_str << ",0"<< std::endl;
    }
    newData << " #define VER_FILEVERSION_STR     \"0, 0, " << rev_str << ", " << hash_str << "\""<< std::endl;
    newData << " #define VER_PRODUCTVERSION_STR  \"0, 0, " << rev_str << ", " << hash_str << "\""<< std::endl;
