...
void WorldDatabaseConnection::DoPrepareStatements()
{
    ...
    */
    PrepareStatement(WORLD_SEL_CREATURE_BY_ID, "SELECT spawnID FROM creature WHERE entry = ?", CONNECTION_SYNCH);
    PrepareStatement(WORLD_SEL_CREATURE_POS_BY_ID, "SELECT spawnID, map, position_x, position_y, position_z, orientation FROM creature WHERE entry = ?", CONNECTION_SYNCH);
    PrepareStatement(WORLD_SEL_CREATURE_COUNT_BY_ID, "SELECT COUNT(spawnID) FROM creature WHERE entry = ?", CONNECTION_SYNCH);
    /*
