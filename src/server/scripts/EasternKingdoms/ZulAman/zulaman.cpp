        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            if (instance)
            {
                ...
                for (uint8 i = 0; i < 4; ++i)
                {
                    ...
                    { 
                        creature->SummonGameObject(ChestEntry[i], Position(x-2, y, z, 0), G3D::Quat(0, 0, 0, 0), 0);
                        break;
                    }
                }
            }
...
class spell_banging_the_gong : public SpellScriptLoader
{
    public:
        ...
        class spell_banging_the_gong_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex index, int32& damage)
            {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_banging_the_gong_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_ACTIVATE_OBJECT);
            }
        };
